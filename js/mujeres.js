...
function renderProducts() {
  ...
  // FILTRAR PRIMERO POR MUJERES
  let filtered = products.filter(function (p) { return p.cat === "Mujer"; });
...
(function() {
  ...
  window.renderProducts = function() {
    ...
    if (currentFilter === "Favoritos") {
      ...
      filtered = products.filter(p => p.cat === "Mujer");
    } else if (currentFilter === "Sale") {
      filtered = products.filter(p => p.cat === "Mujer" && p.badge === "sale");
      ...
      filtered = products.filter(p => p.cat === "Mujer" && categoryMap[currentFilter](p));
    } else {
      filtered = products.filter(p => p.cat === "Mujer");
    }
